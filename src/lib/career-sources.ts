...
export const careerSources: Record<CareerSlug, CareerSourceConfig> = {
  ...
  "software-development": {
    ...
    jobKeywords: {
      primary: ["software developer", "software engineer", "web developer", "frontend", "backend", "full stack", "mobile developer"],
      india: ["software developer", "web developer intern", "React developer"],
      exclude: ["director", "VP"],
      remotiveCategory: "software-development",
      adzunaCategory: "it-jobs",
      adzunaCountries: ["us", "in", "gb"],
  ...
  "business-entrepreneurship": {
    ...
    jobKeywords: {
      primary: ["business analyst", "business development", "strategy", "operations", "consulting", "business"],
      india: ["business analyst", "business development", "operations trainee"],
      exclude: ["director", "VP", "managing"],
  ...
  "retail-logistics": {
    ...
    jobKeywords: {
      primary: ["supply chain", "logistics", "e-commerce", "warehouse", "retail", "inventory", "operations"],
      india: ["supply chain", "logistics coordinator", "ecommerce operations"],
      exclude: ["director", "VP"],
      remotiveCategory: "all-others",
  ...
  "digital-marketing": {
    ...
    jobKeywords: {
      primary: ["digital marketing", "SEO", "content marketing", "social media", "marketing", "growth"],
      india: ["digital marketing", "social media", "SEO"],
      exclude: ["director", "VP"],
  ...
  "hospitality-management": {
    ...
    jobKeywords: {
      primary: ["hospitality", "hotel", "restaurant", "event", "tourism", "front desk", "catering"],
      india: ["hospitality", "hotel trainee", "event coordinator"],
      exclude: ["director", "VP"],
  ...
  "automotive": {
    ...
    jobKeywords: {
      primary: ["automotive", "EV", "electric vehicle", "vehicle", "automobile", "mechanical"],
      india: ["automotive", "EV", "electric vehicle"],
      exclude: ["director", "VP"],
      remotiveCategory: "all-others",
      adzunaCategory: "engineering-jobs",
      adzunaCountries: ["us", "in", "gb"],
  ...
  "architecture-planning": {
    ...
    jobKeywords: {
      primary: ["architect", "urban planning", "interior design", "architecture", "CAD", "BIM"],
      india: ["architect", "urban planning", "interior design"],
      exclude: ["director", "VP"],
      remotiveCategory: "all-others",
      adzunaCategory: "creative-design-jobs",
      adzunaCountries: ["us", "in", "gb"],
